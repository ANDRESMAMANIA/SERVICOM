   ...
   <section class="content">
                        ...
                        <tbody>
                           ...
                           foreach ($clientes as $key => $value) {
                              ...
                              if ($value["estado"] != 0) {
                                 ...
                                 echo '<td><button class="btn btn-success btn-xs btnActivar" idCi="' . $value["id"] . '" estadoCliente="0">Activado</button></td>';
                              } else {

                                 echo '<td><button class="btn btn-danger btn-xs btnActivar" idCi="' . $value["id"] . '" estadoCliente="1">Desactivado</button></td>';
                              }
      ...
      <td>
         ...
         <div class="btn-group">
            ...
            <button class="btn btn-warning btnEditarCliente" idCi="' . $value["id"] . '" data-toggle="modal" data-target="#modalEditarCliente"><i class="fas fa-pencil-alt"></i></button>

            <button class="btn btn-danger btnEliminarCliente" idCi="' . $value["id"] . '"><i class="fa fa-times"></i></button>
         </div>  
